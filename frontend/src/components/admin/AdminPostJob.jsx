...
import useGetAllCompanies from '@/hooks/useGetAllCompanies'; // ✅ Add this

const PostJob = () => {
    useGetAllCompanies(); // ✅ Fetch companies on load
            ...
            <div className='flex items-center justify-center w-screen my-5'>
                <form onSubmit={submitHandler} className='p-8 max-w-4xl border border-gray-200 shadow-lg rounded-md'>
                    <div className='grid grid-cols-2 gap-2'>
                        ...
                        <div><Label>Experience Level</Label><Input type="text" name="experience" value={input.experience} onChange={changeEventHandler} /></div>
                        <div><Label>No of Position</Label><Input type="number" name="position" value={input.position} onChange={changeEventHandler} /></div>
...

                    {
                        loading
                            ...
                            : <Button type="submit" className="w-full bg-blue-500 my-4">Post New Job</Button>
                    }
